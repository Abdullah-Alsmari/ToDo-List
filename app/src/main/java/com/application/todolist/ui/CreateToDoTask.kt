...
var currentDataPos=0
    ...
    override fun onCreateView(
        ...
        bind=DataBindingUtil.inflate(layoutInflater,R.layout.fragment_create_to_do_task,container,false)
        return bind?.root!!
    }
    ...
    viewModel=toDOViewModel
        ...
        btnDoneNotes.setOnClickListener {
            if (args != null) {
                ...
                val toDoModel = ToDoModel(title, subTitle, toDoDate, desc)
                ...
                val toDoDate = tvDate.text.toString()
                val desc = etTakenotes.text.toString()
                val toDoModel = ToDoModel(title, subTitle, toDoDate.substring(0,5), desc)
